...
export const articles = [
  {
    ...
    title: "Biaya Kitchen Set Custom: Cara Mengira-ngira Budget Awal",
    excerpt:
    ...
    keyTakeaways: [
      ...
      "Gunakan level Ekonomis, Standar, Detail Custom, dan Premium untuk memperkirakan kebutuhan Anda masuk kategori mana.",
      "Estimasi awal akan lebih akurat jika Anda mengirim foto ruang, ukuran kasar, referensi desain, dan gambaran budget.",
    ],
    sections: [
      {
      ...
      },
      {
        ...
        body:
          "Cara paling mudah adalah memakai rumus sederhana: ukuran kasar kitchen set dikali kisaran harga per meter lari. Misalnya dapur Anda sekitar 3 meter, maka estimasi awal bisa dihitung dari 3 dikali kisaran per meter. Angka ini bukan harga final, tetapi membantu Anda punya gambaran budget sebelum konsultasi.",
      },
      {
        heading: "Kisaran awal berdasarkan level spesifikasi",
        body:
          "Untuk kitchen set custom, kisaran awal bisa dibagi menjadi beberapa level. Ekonomis biasanya fokus pada fungsi dasar dan detail sederhana. Standar cocok untuk kebutuhan yang rapi dan fungsional. Detail Custom cocok jika ingin banyak laci, kabinet atas-bawah, atau aksesoris tambahan. Premium cocok untuk desain lebih kompleks, finishing lebih tinggi, dan detail visual yang lebih kuat.",
      },
      {
      ...
      },
      {
        ...
        body:
          "Dua kitchen set sama-sama 3 meter belum tentu punya biaya yang sama. Satu proyek mungkin hanya butuh kabinet bawah sederhana, sementara proyek lain butuh kabinet atas-bawah, top table, backsplash, banyak laci, rak piring, lampu LED, finishing khusus, dan aksesoris tambahan. Itulah kenapa estimasi perlu melihat detail kebutuhan, bukan panjang saja.",
      },
      {
      ...
      {
        heading: "Kalau budget terbatas, apakah masih bisa custom?",
        body:
          "Bisa dibahas. Justru dengan menyampaikan gambaran budget sejak awal, opsi desain dan material bisa diarahkan lebih realistis. Misalnya fokus dulu ke fungsi utama, mengurangi aksesoris tertentu, memilih finishing yang lebih sederhana, atau memprioritaskan area yang paling penting.",
      },
      {
        heading: "Apa yang perlu dikirim agar estimasi lebih akurat?",
        body:
          "Untuk estimasi awal, Anda bisa mengirim foto dapur dari beberapa sudut, ukuran kasar panjang area kitchen set, tinggi ruang, referensi desain, kebutuhan penyimpanan, dan gambaran budget. Dari data sederhana itu, BUF bisa membantu memberi arahan awal sebelum masuk ke detail pengukuran dan desain.",
      },
    ],
    faq: [
      {
        ...
        answer:
          "Bukan. Angka di artikel ini adalah kisaran awal untuk membantu pelanggan memperkirakan budget. Harga final tetap menunggu ukuran detail, material, finishing, aksesoris, dan kondisi ruang.",
      },
      {
      ...
      {
        question: "Apakah budget bisa disesuaikan?",
        answer:
          "Bisa dibahas. Dengan mengetahui budget awal, BUF bisa membantu memberi opsi desain, material, dan prioritas pengerjaan yang lebih realistis.",
      },
    ],
  },
  {
