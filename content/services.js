...
export const services = [
  ...
  },
  {
    ...
    heroDescription:
      "Buat furniture yang pas dengan ukuran dan fungsi ruang, mulai dari lemari, meja belajar, meja rias, kabinet, sampai kebutuhan custom lainnya. Konsultasi bisa dimulai dari WhatsApp, lokasi proyek dapat dikonfirmasi.",
  ...
  {
    slug: "interior-toko",
    title: "Interior Toko Custom",
    heroTitle: "Interior Toko untuk Display yang Lebih Tertata",
    heroDescription:
      "Buat tampilan toko lebih rapi, fungsional, dan enak dilihat pelanggan melalui rak custom, area kasir, display produk, dan layout ruang usaha yang sesuai kebutuhan.",
  ...
  {
    slug: "backdrop-tv",
    title: "Backdrop TV Custom",
    heroTitle: "Backdrop TV Custom untuk Ruang yang Lebih Hangat",
    heroDescription:
      "Backdrop TV dibuat menyesuaikan ukuran dinding, kebutuhan penyimpanan, gaya ruang, dan finishing yang diinginkan. Cocok untuk rumah, kamar, ruang keluarga, atau area komersial.",
  ...
  },
  {
    ...
    heroDescription:
      "Lemari custom membantu memaksimalkan ruang penyimpanan tanpa memaksa ukuran furniture jadi. Model, ukuran, material, dan finishing bisa disesuaikan kebutuhan.",
  ...
  },
  {
    ...
    heroDescription:
      "Booth usaha dibuat sesuai jenis produk, ukuran area, kebutuhan display, dan identitas brand. Cocok untuk UMKM makanan/minuman, toko kecil, dan kebutuhan jualan custom.",
  ...
  },
  {
    ...
    heroTitle: "Akrilik Custom untuk Display, Signage, dan Kebutuhan Usaha",
    heroDescription:
      "BUF melayani pengerjaan akrilik custom untuk kebutuhan display usaha, papan nama, plang, rak display, booth, interior toko, kantor, sekolah, dan kebutuhan custom lain. Konsultasi awal bisa dimulai via WhatsApp.",
  ...
  {
    slug: "aluminium",
    title: "Aluminium Custom",
    heroTitle: "Aluminium Custom untuk Rumah, Toko, dan Usaha",
    heroDescription:
      "BUF melayani pekerjaan aluminium custom seperti kusen, pintu, jendela, partisi, etalase, kaca aluminium, dan kebutuhan aluminium lain untuk rumah maupun tempat usaha.",
  ...
  },
  {
    slug: "kanopi",
    title: "Kanopi Custom",
    heroTitle: "Kanopi Custom untuk Rumah, Toko, dan Area Usaha",
    heroDescription:
      "BUF melayani pembuatan kanopi custom untuk teras, carport, toko, dan area usaha. Ukuran, material, model, dan finishing dapat disesuaikan dengan kebutuhan bangunan.",
    shortTitle: "Kanopi",
    href: routes.kanopi,
    category: "Exterior & Building Support",
    group: "Exterior & Building Support",
