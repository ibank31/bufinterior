...
export const staticPageMetadata = {
  ...
  tentangKami: {
    ...
    description: "Workshop interior custom BUF di Berkoh, Purwokerto. Mengerjakan kitchen set, lemari, booth, backdrop TV, akrilik, aluminium, kanopi, dan interior rumah.",
